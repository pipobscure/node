...
// activeVFSList + findVFS* live in a tiny registry so the resolution fast path
// can consult them without loading this (heavy) module; see registry.js.
const {
  activeVFSList,
  addVFS,
  removeVFS,
