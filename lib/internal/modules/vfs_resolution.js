...
// From the tiny registry, not internal/vfs/setup: this runs on every module
// resolution, and the registry answers "no VFS mounted" without loading the
// heavy internal/vfs machinery (which stays off the startup path and out of
// the startup snapshot; see test/parallel/test-bootstrap-modules.js).
const { findVFSForPath } = require('internal/vfs/registry');
